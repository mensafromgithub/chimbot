greet = "Привет, {name}, я бот, использующий нейросеть Кандински"
menu = "📍 Главное меню"
_help = "Для генерации изображений нажми в меню на '🐹 Kand'\nДоступные стили: \n•⩊• стиль аниме, \n👨🏻‍🎨 стиль Кандински, \n⚡ свой стиль, \n💎 детализированное изображение"
...
kand_watermark = "Кандински сделал"
kand_style = 'Выбери стиль'
kand_prompt = 'Теперь промт'
kand_aprompt = 'Теперь антипромт'
